...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const additional = (interaction.options.getString('additional') === null) ? '*None*' : interaction.options.getString('additional');
        ...
        await interaction.reply({ content: 'Your application has been received and will be reviewed within 48 hours.', ephemeral: true });
    },
};