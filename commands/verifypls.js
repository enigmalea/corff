...
module.exports = {
  ...
  async execute(interaction) {
    ...
    welcomeChannel.send(
      `${member} please be sure to submit your verification information to ${modRole} by running the slash command \`/apply\` and providing your age (required), social media account (required), and any `
    );
    await interaction.reply({
      content: `${member} has been reminded to verify!`,
      ephemeral: true,
    });
  },
};
